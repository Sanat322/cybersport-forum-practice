...
const TopTeams = ["Team Spirit", "Gaimin Gladiators", "Team Liquid",
    "Tundra Esports", "BB Team", "Xtreme Gaming", "Nigma Galaxy", "Team Falcons", "PVISION", "Aurora Gaming", "BOOM Esports", "Team Tidebound", "HEROIC", "Team Nemesis", "NAVI Junior", "Wildcard"];
...
const renderTeamPlayers = (teams) => {
    ...
    Object.entries(teams).forEach(([teamName, players]) => {
        ...
        teamContainer.innerHTML = `
            <a href ="teamPage.html?name=${encodeURIComponent(teamName)}">
                <p>${teamName}</p>
