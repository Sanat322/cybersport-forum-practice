                        ...
                        <div class="ability-display">
                            ...
                            <div class ="ability-info" data-ability-info>
                                <div class ="ability-info-title">
                                    ...
                                    <div class = "ability-info-title-text">
                                        <p><strong></strong><span data-ability-info-name>-</span></p>
                                        <p data-ability-desc></p>
                                    </div>
                                </div>
                                <div class = "ability-cost">
                                    <p class = info-cd-mc><strong>Mana cost: </strong><span data-ability-info-manacost>-</span></p>
                                    <p class = info-cd-mc><strong>Cooldown: </strong><span data-ability-info-cooldown>-</span></p>
                                    <p class = info-cd-mc><strong>Damage Type: </strong><span data-ability-damage>-</span></p>
                                </div>
                                <div class = "ability-attrib">
                                    <p data-ability-info-attrib></p>
                                </div>
                                <p class = "info-lore" data-ability-info-lore></p>
